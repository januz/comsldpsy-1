...
1. One can *download the compendium as a zip archive* from from this [GitHub repository](https://github.com/`r pkgenv$url_github`/archive/master.zip) or a registered/frozen version from the associated [OSF project](`r pkgenv$url_osf`files).
